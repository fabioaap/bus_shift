...
> ⚠️ *Nota: o `README.md` desta pasta referencia Unity 6000.3.2f1. Este documento adota Unity 2022.3 LTS conforme decisão confirmada no briefing técnico. Alinhar com o time antes de iniciar a implementação.*
...
|---|---|---|
| **Versão** | 2022.3.x LTS | Suporte de longo prazo (mínimo 2 anos), estabilidade garantida para indie game |
